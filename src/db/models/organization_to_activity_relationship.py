...
class OrganizationToActivityRelationship(BaseModel, IDMixin):
    ...
    organization_id: Mapped[id] = mapped_column(Integer, ForeignKey("organizations.id"), nullable=False)
    activity_id: Mapped[id] = mapped_column(Integer, ForeignKey("activities.id"), nullable=False)
